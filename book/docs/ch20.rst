...
matrix stack at the time "glVertex" is called, "gl_ProjectionMatrix" is the top of
...
In OpenGL 2.1, the output of the vertex shader that we use here is "gl_FrontColor",
...
the color [2]_.  Is "gl_Color" in the fragment shader the same "gl_Color" from the vertex
shader, or is it the value of the vertex shader's output "gl_FrontColor"?  Honestly,
