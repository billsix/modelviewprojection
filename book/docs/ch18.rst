...
Implement a :term:`perspective projection <Perspective Projection>` so that objects
...
Load src/modelviewprojection/demos/demo18.py in Spyder and hit the play button.
...
Top calculation based off of vertical :term:`field of view <Field of View>`
...
Right calculation based off of Top and :term:`aspect ratio <Aspect Ratio>`
...
``Vector3`` is the same data structure introduced when we added the Z axis; it is unchanged here.
...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   ...
   :end-before: doc-region-end perspective signature
   :language: python
   :linenos:
   :lineno-match:
...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :start-after: doc-region-begin perspective body
...
.. literalinclude:: ../../src/modelviewprojection/demos/demo18.py
   :language: python
   :start-after: doc-region-begin begin event loop
   :end-before: doc-region-end begin event loop
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/demos/demo18.py
