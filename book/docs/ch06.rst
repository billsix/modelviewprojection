...
named "mathutils.py".  The main class in this module is "Vector2D",
...
``Vector2D`` is the same data structure introduced earlier; it is unchanged here.

In a Python class, we can overload the '+' symbol, to make
objects addable, by implementing the :py:meth:`__add__ <modelviewprojection.mathutils.Vector.__add__>`
...
by implementing the :py:meth:`__sub__ <modelviewprojection.mathutils.Vector.__sub__>`
method.
...
on Vector2D class, and it's wrapped in a class named
...
the adding of the Vector2Ds will be the function, but
:class:`InvertibleFunction <modelviewprojection.mathutils.InvertibleFunction>`
...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin begin define invertible function
   :end-before: doc-region-end begin define invertible function
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/mathutils.py
...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin begin call
   :end-before: doc-region-end begin call
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/mathutils.py
...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin call definition
   :end-before: doc-region-end call definition
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/mathutils.py
...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin begin define inverse
   :end-before: doc-region-end begin define inverse
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/mathutils.py
...
by implementing the :py:meth:`__mul__ <modelviewprojection.mathutils.Vector.__mul__>`
and :py:meth:`__rmul__ <modelviewprojection.mathutils.Vector.__rmul__>` methods, where __rmul__ just means
...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin define mul body
   :end-before: doc-region-end define mul body
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/mathutils.py
