...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin define vector3d class
   :end-before: doc-region-end define vector3d class
   :linenos:
   :lineno-match:
...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin define vector3d basis
   :end-before: doc-region-end define vector3d basis
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/mathutils.py
