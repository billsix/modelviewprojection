...
.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin define vector2d class
   :end-before: doc-region-end define vector2d class
   :linenos:
   :lineno-match:
...
.. code:: Python
       ...
       >>> shift = translate(b=Vector2D(x=3, y=4))
...
.. code:: Python
       ...
       >>> from modelviewprojection.mathutils import Vector2D, translate
       >>> shift = translate(b=Vector2D(3, 4))
       >>> shift(Vector2D(1, 2))
       Vector2D(x=4, y=6)
...
``e_2`` is one unit along the y axis.  ``Vector2D`` provides them (and the
origin, ``zero``) as static methods:

.. literalinclude:: ../../src/modelviewprojection/mathutils.py
   :language: python
   :start-after: doc-region-begin define vector2d basis
   :end-before: doc-region-end define vector2d basis
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/mathutils.py
