...
Objective
^^^^^^^^^
Rotate the square around its :term:`origin <Origin>`.
...
Load src/modelviewprojection/demos/demo12.py in Spyder and hit the play button.
...
.. literalinclude:: ../../src/modelviewprojection/demos/demo12.py
   :language: python
   :start-after: doc-region-begin define square rotation
   :end-before: doc-region-end define square rotation
   :linenos:
   :lineno-match:
   :caption: src/modelviewprojection/demos/demo12.py
...
Since we just want to add one :term:`rotation <Rotation>` at the end of the sequence
of :term:`transformations <Transformation>` from paddle 1 space to square space, just add
