...
| Wrong code names in prose: `modelspace_to_ndc`→`modelspace_to_ndc_fn` (ch16:184); `camera_space_to_ndc_space_fn`→`cs_to_ndc_space_fn` (ch16:231, ch17:310 — verify vs demo wrapper) | [`../plans/fix-method-vs-function-wording.md`](../plans/fix-method-vs-function-wording.md) |
