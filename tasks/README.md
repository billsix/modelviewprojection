...
| De-duplicate per-demo `handle_inputs` (the camera-walk sub-block) | ✅ complete 2026-06-01 — 13 demos now share `walk_around_camera`; orbit demos converted to walk-around | [`../plans/dedup-handle-inputs.md`](../plans/dedup-handle-inputs.md) |
