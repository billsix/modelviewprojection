...
| **Move keyboard render-options to imgui** (mode toggles/shader-select/etc. → checkboxes/combos) | in progress — full audit done: 16 demos (GROUP A) need work, ~19 already have panels; awaiting go-ahead on conventions | [`ports-render-options-to-imgui.md`](ports-render-options-to-imgui.md) |
