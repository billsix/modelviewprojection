...
|------|---------|-------------------|
| ch1–6 | [`book-code-drift-ch1-6.md`](archive/2026/05/27/book-code-drift-ch1-6.md) | natural-basis, is_clockwise, ch05-section, ch02/03-typos |
...
✅ [`archive/book-explain-natural-basis.md`](archive/2026/05/26/book-explain-natural-basis.md) (headline — DONE; e_1/e_2/e_3 now introduced 2D in ch05, 3D in ch14) ·
✅ [`archive/fix-method-vs-function-wording.md`](archive/2026/05/26/fix-method-vs-function-wording.md) (DONE) ·
✅ [`archive/fix-mathutils-latex-and-error-strings.md`](archive/2026/05/26/fix-mathutils-latex-and-error-strings.md) (DONE) ·
✅ [`archive/fix-is-clockwise-recursion.md`](archive/2026/05/26/fix-is-clockwise-recursion.md) (DONE) ·
✅ [`archive/fix-demo-code-bugs.md`](archive/2026/05/26/fix-demo-code-bugs.md) (DONE — demo14 `zero`, demo21 imports) ·
✅ [`archive/ch05-translate-section-fixes.md`](archive/2026/05/26/ch05-translate-section-fixes.md) (DONE) ·
✅ [`archive/ch02-ch03-prose-typos.md`](archive/2026/05/26/ch02-ch03-prose-typos.md) (DONE)
...
| **Separate data generation from rendering** in SuperBible ports (precompute trig into `_primitives` builders) | ✅ complete 2026-05-29 — archived (~30 demos converted; leave-alone set documented; spot-checked by Bill) | [`archive/extract-data-generation.md`](archive/2026/05/29/extract-data-generation.md) |
| **Cube-map sphere reflection doesn't track the camera** (ch09 port bug) | ✅ complete 2026-06-01 — archived (multitexture fixed; texgen/thundergl/fboenvmap audited as N/A) | [`archive/cubemap-reflection-static.md`](archive/2026/06/01/cubemap-reflection-static.md) |
...
| **Move keyboard render-options to imgui** (mode toggles/shader-select/etc. → checkboxes/combos) | ✅ complete 2026-06-01 — archived (all 18 demos converted; Bill verified) | [`archive/ports-render-options-to-imgui.md`](archive/2026/06/01/ports-render-options-to-imgui.md) |
| **Mirror every keyboard control in an imgui menubar** (94 demos) | ✅ complete 2026-06-02 — archived (all 94 demos have a top menubar; texture-state fallout swept) | [`archive/ports-mirror-keyboard-in-imgui.md`](archive/2026/06/01/ports-mirror-keyboard-in-imgui.md) |
| **hdrbloom crashes on startup** (after-glow PBO allocated 1 byte) | ✅ complete 2026-06-02 — archived (sized the PBO in setup_rc; Bill confirmed run) | [`archive/hdrbloom-pbo-sizing-crash.md`](archive/2026/06/01/hdrbloom-pbo-sizing-crash.md) |
