...
| Path | What |
| --- | --- |
| `src/modelviewprojection/` | The package: `mathutils.py` (gacalc-backed graphics math; not a re-export façade), `matrix_stack.py`, `demos/`, `util/`, `framebuffer/`, `mvpvisualization/` |
