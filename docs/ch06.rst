...
Paddle 1's graph paper gets -90 units in the x direction, and some
number of units in the y direction based off of user input.  The origin
...
.. figure:: _static/translation-forwards-4.png
    :align: center
...
.. figure:: _static/translation2-forwards-4.png
    :align: center
    :alt: Paddle 1's Verticies in World Space
    :figclass: align-center
...
As a demostration (that we don't use exactly in this code), let's make an
object's width twice as large, and height three times as large.
