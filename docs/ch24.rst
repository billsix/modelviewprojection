Towards Standard Projection Matrix Pt 2 Demo 24
===============================================
...
On Linux or on MacOS, in a command prompt, type "python src/demo24/demo.py".
On Windows, in a command prompt, type "python src\\demo24\\demo.py".
