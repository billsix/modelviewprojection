...
.. math::
    ...
    \vec{Rotate}(\vec{Translate}(\vec{v_{modelspace_{p1}}}; \vec{v_{offset_{p1}}}), \theta_{p1})
    \end{equation*}
...
.. math::
    ...
    \vec{Rotate}(\vec{Translate}(\vec{v_{modelspace_{p2}}}; \vec{v_{offset_{p2}}}), \theta_{p2})
    \end{equation*}
...
.. math::
    ...
    \begin{equation*}
    \vec{f}_{p1}^{w}(\vec{v_{modelspace_{p1}}}) =
    (\vec{Rotate}(;\theta_{p1}) \circ \vec{Translate}(; \vec{v_{offset_{p1}}})) (\vec{v_{modelspace_{p1}}})
    \end{equation*}
...
.. math::
    ...
    \begin{equation*}
    \vec{f}_{p2}^{w}(\vec{v_{modelspace_{p2}}}) =
    (\vec{Rotate}(;\theta_{p2}) \circ \vec{Translate}(; \vec{v_{offset_{p2}}})) (\vec{v_{modelspace_{p2}}})
    \end{equation*}
...
.. math::
    ...
    \begin{equation*}
    \vec{f}_{p1}^{w} =
    \vec{Rotate}(;\theta_{p1}) \circ \vec{Translate}(; \vec{v_{offset_{p1}}})
    \end{equation*}
...
.. math::
    ...
    \begin{equation*}
    \vec{f}_{p2}^{w} =
    \vec{Rotate}(;\theta_{p2}) \circ \vec{Translate}(; \vec{v_{offset_{p2}}})
    \end{equation*}
