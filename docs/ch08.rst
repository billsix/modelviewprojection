...
In this demo, we translate the paddles to their position,
then to rotate about the paddle's center, we translate
back to the origin, rotate, and then translate again back to the paddle's position.
