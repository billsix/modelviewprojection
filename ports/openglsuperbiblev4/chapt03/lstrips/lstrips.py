...
# Python port of LStrips.cpp by Richard S. Wright Jr.
...
def main() -> None:
    ...
    window = glfw.create_window(window_width, window_height, "Line Strips Example", None, None)
    if not window:
        glfw.terminate()
        sys.exit(1)
