# linesw.py
# Demonstrates GL_LINES with varying line widths
# OpenGL SuperBible, Chapter 3
# Python port of Linesw.cpp by Richard S. Wright Jr.
...
def main() -> None:
    ...
    window = glfw.create_window(window_width, window_height, "Line Width Example", None, None)
    if not window:
        glfw.terminate()
        sys.exit(1)
