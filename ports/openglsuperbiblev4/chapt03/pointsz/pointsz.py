# pointsz.py
# Demonstrates GL_POINTS with point size
# OpenGL SuperBible, Chapter 3
# Python port of Pointsz.cpp by Richard S. Wright Jr.
...
def render_scene() -> None:
    ...
    step = GL.glGetFloatv(GL.GL_POINT_SIZE_GRANULARITY)
...
def main() -> None:
    ...
    window = glfw.create_window(window_width, window_height, "Point Sizes Example", None, None)
    if not window:
        glfw.terminate()
        sys.exit(1)
