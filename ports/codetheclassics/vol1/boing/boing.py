...
# Code the Classics -- "Boing!"  (PyGame Zero -> GLFW + OpenGL 3.3 core port)
#
# Original game (c) Raspberry Pi Press and the authors of "Code the Classics
# Volume I".  All rights in the original code and assets remain with their
# owners; this port is included in ModelViewProjection for educational use.
...
#
# This file is a near-verbatim copy of the original boing.py.  Only the framework
# layer changed: instead of PyGame Zero (pgzero/pygame) it runs on `pgzero_gl`,
# a compatibility shim that reimplements the slice of the PyGame Zero API this
