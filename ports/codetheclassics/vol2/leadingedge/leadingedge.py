...
# Original game from "Code the Classics" Vol 2 (Raspberry Pi Press); ported to
# GLFW + OpenGL. Full license text: ports/codetheclassics/LICENSE.
# Copyright/license source: http://archive.raspberrypi.org/debian/pool/main/c/code-the-classics-2/code-the-classics-2_0.1.tar.xz (debian/copyright)
